<?php
	...
	//kontrolli kas post info jõuab kuhugi
	//var_dump($_POST);
	...
	if(isset($_POST["adjective_submit"])){
		...
		//kontollime, kas midagi kirjutati kas
	...
	//näiteks:
	//<ul>
	//		<li>pildiailinimi1.jpg</li>
	//		<li>pildiailinimi2.jpg</li>
	//		<li>pildiailinimi3.jpg</li>
	//</ul>
...
<body>
	...
	<hr>
	<form method="POST">
		<input type="text" placeholder="omadussõna tänase kohat" name="todays_adjective_input" value="<?php echo $todays_adjective; ?>">
