...
window.onload = function(){
	//loean kokku kõik pisipildid ja määran kõigile hiirekliki kuulamise
	...
	if(rating > 0){
		...
		webRequest.onreadystatechange = function(){
			...
			if(this.readyState == 4 && this.status == 200){
				...
				document.querySelector("#avgRating").innerHTML = "Keskmine hinne: " + this.responseText;document.querySelector("#storeRating").removeEventListener("click", storeRating);
			}
